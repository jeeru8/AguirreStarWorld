...
<html>
<head>
  <title>Car Rentals | Aguirre Star Worldwide Travel Corporation</title>
          ...
          <div class="col s10 l4 push-s1 push-l4">
              ...
              <div class="card grey lighten-5">
                <form class="card-content black-text">
                    <!--origin-->
                    <div class="row">
                      <div class="col s4 l5 push-l1"><p class="teal-text darken-4">Pick up location</p></div>
                    ...
                    <!--destination-->
                    <div class="row">
                      <div class="col s4 l5 push-l1"><p class="teal-text darken-4">Drop off location</p></div>
                      <div class="form-group input-field col s8 l5 push-l1"  >
                        <select ng-model="account.status">
                          <option value="" disabled>Choose your option</option>
                          <option value="Philippines" >Philippines</option>
